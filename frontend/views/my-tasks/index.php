...
<section class="menu-toggle">
    <ul class="menu-toggle__list">
        <li class="menu-toggle__item menu-toggle__item--completed <?= $filter === MyTaskListFilterConstants::COMPLETED ? 'menu_toggle__item--current' : ''?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <?= $filter === MyTaskListFilterConstants::COMPLETED ? 'fill="white"' : ''?>/>
                </svg>
            </div>
            <a href="/my-tasks?filter=<?= MyTaskListFilterConstants::COMPLETED ?>">
                Завершённые
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--new <?= $filter === MyTaskListFilterConstants::NEW ? 'menu_toggle__item--current' : ''?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        ...
                        <?= $filter === MyTaskListFilterConstants::NEW ? 'fill="white"' : ''?>/>
                    <path
            ...
            <a href="/my-tasks?filter=<?= MyTaskListFilterConstants::NEW ?>">
                Новые
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--active <?= $filter === MyTaskListFilterConstants::ACTIVE ? 'menu_toggle__item--current' : ''?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <?= $filter === MyTaskListFilterConstants::ACTIVE ? 'fill="white"' : ''?>/>
                </svg>
            </div>
            <a href="/my-tasks?filter=<?= MyTaskListFilterConstants::ACTIVE ?>">
                Активные
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--canceled <?= $filter === MyTaskListFilterConstants::CANCELED ? 'menu_toggle__item--current' : ''?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <?= $filter === MyTaskListFilterConstants::CANCELED ? 'fill="white"' : ''?>/>
                </svg>
            </div>
            <a href="/my-tasks?filter=<?= MyTaskListFilterConstants::CANCELED ?>">
                Отменённые
            </a>
        </li>
        <li class="menu-toggle__item menu-toggle__item--hidden <?= $filter === MyTaskListFilterConstants::EXPIRED ? 'menu_toggle__item--current' : ''?>">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <?= $filter === MyTaskListFilterConstants::EXPIRED ? 'fill="white"' : ''?>/>
                </svg>
            </div>
